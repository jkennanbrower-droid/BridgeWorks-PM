...
export function ProfileBlock({ profile, collapsed = false }: ProfileBlockProps) {
  ...
  if (collapsed) {
    return (
      <div className="flex items-center justify-center rounded-2xl border border-white/10 bg-white/5 px-3 py-3 text-white">
        <div className="relative" title={`${profile.name} · ${profile.roleLabel}`}>
